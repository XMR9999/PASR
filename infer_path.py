...
from pasr.predict import PASRPredictor
...
add_arg('punc_model_dir',   str,    'models\punc_models',                          "标点符号的模型文件夹路径")
add_arg('punc_online_model_dir',    str,   'models\punc_online_models',                   "流式标点符号的模型文件夹路径")
args = parser.parse_args()
print_arguments(args=args)

# 获取识别器
predictor = PASRPredictor(model_dir=args.model_dir,
