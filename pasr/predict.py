...
from pasr.infer_utils.inference_predictor import InferencePredictor
from pasr.utils.utils import dict_to_object, print_arguments
...
class PASRPredictor:
    def __init__(self,
        ...
        self._tokenizer = PASRTokenizer(vocab_model_dir=vocab_model_dir)
        ...
        # 加载标点符号模型
        if punc_model_dir:
            from pasr.infer_utils.punc_predictor import PunctuationPredictor
        ...
        if punc_online_model_dir and self.model_info.streaming:
            from pasr.infer_utils.punc_predictor import PunctuationOnlinePredictor
